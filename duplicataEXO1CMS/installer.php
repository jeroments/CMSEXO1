...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230104_exointegration1_0d7dcb60be9bfd4f2612_20230104135644_archive.zip';
        const ARCHIVE_SIZE       = '60985617';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0d7dcb6-04135644';
        const SECONDARY_PACKAGE_HASH = '1b1989c-04135644';
        const VERSION            = '1.5.1';
